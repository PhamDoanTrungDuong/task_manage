<template>
   <div className="h-[90vh] flex justify-center items-center">
      <div class="max-w-[400px] mx-auto p-10 border border-slate-500/50 shadow-md rounded-xl bg-white">
         <div class="text-center my-5 text-xl font-bold">
            <h1>SIGN IN</h1>
         </div>
         <form>
            <div class="mb-6">
            ...
            <div class="text-center">
               ...
               <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                  ...
                  <a
                     href="#!"
                     class="text-indigo-600 hover:text-indigo-700 focus:text-indigo-700 transition duration-200 ease-in-out"
                     >Register</a
                  >
               </p>
            </div>
